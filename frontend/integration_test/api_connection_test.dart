...
/// Real end-to-end integration test against live backend running on http://localhost:8080.
/// Run this test when the Spring Boot backend server is active:
///   flutter test integration_test/api_connection_test.dart
void main() {
  test('Test Live API Connections (Real Simulation)', () async {
