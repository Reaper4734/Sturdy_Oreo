...
* **Responsibility**:
  ...
  * **Live Voice Convo**: Includes a toggle button (similar to the Gemini app) that transitions the text chat into a real-time, low-latency audio conversation using the Gemini Live API, fully grounded in the current Canvas topic context.
