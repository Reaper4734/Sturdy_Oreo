...
public class PlannerController {
    ...
    public PlannerController(PlannerAssistant plannerAssistant, ChatSummarizer chatSummarizer,
            LearningPlanRepository learningPlanRepository, SimpMessagingTemplate messagingTemplate) {
    ...
    public ResponseEntity<Map<String, String>> generatePlan(
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                messagingTemplate.convertAndSend("/topic/session/user/" + userId + "/error",
                        Map.of("error", e.getMessage()));
            }
        });

        return ResponseEntity.accepted()
                .body(Map.of("status", "processing", "message", "Plan generation started asynchronously."));
    }
    ...
    public ResponseEntity<Map<String, String>> adaptPlan(
        ...
        return ResponseEntity.accepted()
                .body(Map.of("status", "processing", "message", "Plan adaptation started asynchronously."));
    }
